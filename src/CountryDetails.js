...
export default function CountryDetails() {
  ...
  const DataRow = ({ label, value, unit }) => (
    <div style={{ marginBottom: '18px' }}>
      <p style={{ fontSize: '11px', color: TEXT_DIM, margin: '0 0 6px 0', letterSpacing: '0.05em' }}>{label}</p>
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
        <h2 style={{ margin: 0, color: TEXT, fontSize: '28px', fontFamily: 'monospace' }}>{value}<span style={{ fontSize: '16px', color: TEXT_DIM, fontFamily: "'Inter', sans-serif" }}>{unit}</span></h2>
        <div style={{ width: '100px', height: '4px', background: isLight ? '#e5e7eb' : 'rgba(255,255,255,0.1)', borderRadius: '2px' }}>
    ...
    <div style={{ background: BG, minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ padding: '0 2rem' }}>
            ...
            <div style={CARD}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '13px', color: TEXT_DIM, margin: '0 0 4px 0' }}>14d avg evap: <b style={{ color: TEXT }}>{drought.evap14} mm/day</b></p>
                  <p style={{ fontSize: '13px', color: TEXT_DIM, margin: 0 }}>Temp max: <b style={{ color: TEXT }}>{drought.tempMax}°C</b></p>
                </div>
              </div>
        ...
        <div style={{ marginBottom: '25px' }}>
          <p style={{ fontSize: '11px', color: TEXT_DIM, margin: 0, letterSpacing: '0.05em' }}>LAST SYNC</p>
          <h2 style={{ margin: '5px 0', color: TEXT, fontSize: '24px', fontFamily: 'monospace' }}>{data.last_sync}</h2>
        ...
        <div style={CARD}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
            <h3 style={{ margin: 0, color: TEXT, fontSize: '18px' }}>Atmospheric Data</h3>
        ...
        {hasGas && (
          <div style={CARD}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
              <h3 style={{ margin: 0, color: TEXT, fontSize: '18px' }}>Trace Gas</h3>
            ...
            <p style={{ fontSize: '12px', color: TEXT_DIM, margin: '10px 0 0 0', letterSpacing: '0.05em' }}>PPM LEVELS</p>
          </div>
        )}
      </div>
    </div>
